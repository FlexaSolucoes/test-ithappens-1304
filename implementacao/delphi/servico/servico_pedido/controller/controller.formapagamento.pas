...
type
  TFormaPagamentoController = class(TDSServerModule)
  private
...
var
  FormaPagamentoController: TFormaPagamentoController;
...
function TFormaPagamentoController.acceptFormaPagamento(
...
function TFormaPagamentoController.cancelFormaPagamento(id: Integer): TJSONValue;
begin
     Result:=TJSONString.Create('Não é possivel apagar o registro!');
end;

function TFormaPagamentoController.FormaPagamento(id: Integer): TJSONValue;
var sSQL:String;
begin
...
function TFormaPagamentoController.updateFormaPagamento(
  FormaPagamento: TJSONObject): TJSONValue;
var sSQL:String;
var f:model.entity.formapagamento.Tformapagamento;
begin
